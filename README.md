# 안녕하세요. 저는 신입 개발자 김태극입니다.

**빠르게 배우고, 바로 만들어내는 Python 개발자입니다.**

- 부트캠프 약 6개월 동안 Python · FastAPI · PostgreSQL · Docker를 공부하여 3개의 프로젝트를 완성했습니다.
...
- DB 조회 엔드포인트 평균 응답시간 **141ms** (Render 무료 플랜 · Supabase Connection Pooler 환경)
